...
int sam_m8q_enable(struct device *dev, gnss_status_callback_t status_cb) {
...
static struct gnss_driver_api sam_m8q_api_funcs = {
      .sample_fetch = sam_m8q_sample_fetch,
      .channel_get = sam_m8q_channel_get,
      .attr_get = sam_m8q_attr_get,
      .attr_set = sam_m8q_attr_set,
      .trigger_set = sam_m8q_trigger_set,
      .enable = sam_m8q_enable
};
